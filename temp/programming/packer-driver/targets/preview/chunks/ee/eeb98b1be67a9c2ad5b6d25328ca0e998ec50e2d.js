    ...
    execute: function () {
      ...
      _export("EnemySpawner", EnemySpawner = (_dec = ccclass('EnemySpawner'), _dec2 = property({
        ...
        spawnRandomObject() {
          ...
          var randomIndex = Math.floor(Math.random() * this.prefabsToSpawn.length);
          var selectedPrefab = this.prefabsToSpawn[randomIndex]; // Создаем копию выбранного префаба

          var spawnedObj = instantiate(selectedPrefab);
          ...
          var controller = spawnedObj.getComponent('EnemyController');

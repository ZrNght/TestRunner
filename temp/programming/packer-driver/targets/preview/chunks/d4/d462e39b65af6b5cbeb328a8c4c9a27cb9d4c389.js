      ...
      _export("ScoreManager", ScoreManager = (_dec = ccclass('ScoreManager'), _dec2 = property({
        ...
        start() {
          ...
          if (this.complimentContainer) {
            for (var child of this.complimentContainer.children) {
        ...
        showRandomCompliment() {
          ...
          var children = this.complimentContainer.children;
          var randomIndex = Math.floor(Math.random() * children.length);
          var complimentNode = children[randomIndex];
          var uiOpacity = complimentNode.getComponent(UIOpacity);
          ...
          var originalPos = this.originalPositions.get(complimentNode) || new Vec3(0, 0, 0);

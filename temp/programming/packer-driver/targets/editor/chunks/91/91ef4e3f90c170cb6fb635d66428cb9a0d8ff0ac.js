System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Collider2D, Contact2DType, Animation, Sprite, Color, tween, UIOpacity, _dec, _class, _class2, _descriptor, _crd, ccclass, property, PlayerHitbox;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("PlayerHitbox", PlayerHitbox = (_dec = ccclass('PlayerHitbox'), _dec(_class = (_class2 = class PlayerHitbox extends Component {
        constructor(...args) {
          super(...args);
